...
class LineChartNew extends StatefulWidget {
  ...
  const LineChartNew({Key? key, required this.scores}) : super(key: key);

  @override
  _LineChartNewState createState() => _LineChartNewState();
}

class _LineChartNewState extends State<LineChartNew> {
