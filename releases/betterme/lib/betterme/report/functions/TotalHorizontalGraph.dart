...
class CustomeScatterChartPainterSleep extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
      ...
      sleep[i].forEach((e) {
        ...
        if (e[2] != 0) {
          ...
          if (e[0] == e[1]) {
            ...
            //     Offset(left_border + wd * startTime + temp,
            //         right_border + hd * i - tmp),
            //     Offset(left_border + wd * endTime - temp,
            //         right_border + hd * i - tmp),
            //     paint_);
            // canvas.drawLine(
            //     Offset(left_border + wd * startTime + temp,
            ...
            if (left_border + wd * endTime - temp < 27) {
              canvas.drawLine(
                  Offset(left_border + wd * startTime + temp,
                      right_border + hd * i - tmp),
                  Offset(27, right_border + hd * i - tmp),
                  paint_);
              canvas.drawLine(
                  Offset(left_border + wd * startTime + temp,
                      right_border + hd * i + tmp),
              ...
              canvas.drawLine(
                  ...
                  Offset(left_border + wd * startTime + temp,
                      right_border + hd * i - tmp),
                  paint_);
              canvas.drawLine(Offset(27, right_border + hd * i + tmp),
                  Offset(27, right_border + hd * i - tmp), paint_);
              canvas.drawLine(
                  Offset(left_border + wd * startTime, right_border + hd * i),
                  Offset(left_border + wd * endTime, right_border + hd * i),
                  paint3);
    ...
    Paint paintline = Paint() // Paint 클래스는 어떤 식으로 화면을 그릴지 정할 때 쓰임.
      ...
      ..strokeWidth = 15.0; // 선의 굵기는 4.0
    canvas.drawLine(
        Offset(left_border + drawableWidth + 8.5, -5),
        Offset(left_border + drawableWidth + 8.5, drawableHeight - 10),
        paintline);
