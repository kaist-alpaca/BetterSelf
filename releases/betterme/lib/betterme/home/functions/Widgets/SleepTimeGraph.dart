...
class SleepTimeGraph extends StatefulWidget {
  SleepTimeGraph(double widgetHeight1, double widgetWidth1) {
    widgetHeight2 = widgetHeight1;
    widgetWidth2 = widgetWidth1;
  }
  @override
  _SleepTimeGraph createState() => _SleepTimeGraph();
}

class _SleepTimeGraph extends State<SleepTimeGraph> {
  @override
