...
class FoodDailyMenu3 extends StatefulWidget {
  FoodDailyMenu3(int type1, double widgetHeight1, double widgetWidth1) {
    widgetHeight2 = widgetHeight1;
    widgetWidth2 = widgetWidth1;
    type = type1;
  }
  @override
  _FoodDailyMenu3 createState() => _FoodDailyMenu3();
}

class _FoodDailyMenu3 extends State<FoodDailyMenu3> {
  @override
