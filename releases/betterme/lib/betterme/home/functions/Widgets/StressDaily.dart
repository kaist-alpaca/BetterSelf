...
class StressDaily extends StatefulWidget {
  StreeDaily(double widgetHeight1, double widgetWidth1) {
    widgetHeight2 = widgetHeight1;
    widgetWidth2 = widgetWidth1;
  }

  @override
  _StressDaily createState() => _StressDaily();
}

class _StressDaily extends State<StressDaily> {
  @override
