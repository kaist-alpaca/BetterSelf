...
class FoodDailyMenu1 extends StatefulWidget {
  FoodDailyMenu1(int type1, double widgetHeight1, double widgetWidth1) {
    widgetHeight2 = widgetHeight1;
    widgetWidth2 = widgetWidth1;
    type = type1;
  }
  @override
  _FoodDailyMenu1 createState() => _FoodDailyMenu1();
}

class _FoodDailyMenu1 extends State<FoodDailyMenu1> {
  @override
