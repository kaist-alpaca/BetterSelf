...
class MadeLineChart2 extends StatefulWidget {
  final List<Score> scores;
  const MadeLineChart2({Key? key, required this.scores}) : super(key: key);

  @override
  _MadeLineChart2State createState() => _MadeLineChart2State();
}

class _MadeLineChart2State extends State<MadeLineChart2> {
