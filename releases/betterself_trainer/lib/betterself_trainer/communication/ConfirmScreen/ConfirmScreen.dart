import 'package:betterself_trainer/betterself_trainer/home/functions/Widgets/CoachingInside.dart';
...
class _ConfirmScreenState extends State<ConfirmScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var userlistStream =
        FirebaseFirestore.instance.collection('users').doc(currentuser).collection('add_query').snapshots();
