...
class Profile extends GetView<ProfileController> {
  ...
  Widget _profileImageWidget() {
    print(controller.myProfile.value.avatarUrl);
    return controller.myProfile.value.avatarUrl == null
        ? Image.network(
            "https://cdn.dribbble.com/users/4582465/screenshots/9143623/media/817f2b4128a2b310930bc8259adbc81e.jpg?compress=1&resize=400x300",
            fit: BoxFit.cover,
          )
        : Image.network(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Text(
            controller.myProfile.value.name == null
                ? ""
        ...
        Text(
          controller.myProfile.value.discription == null
              ? ""
        ...
        () => Column(
          children: [
            ...
            _partProfileInfo(
                controller.myProfile.value.discription == null
                    ? "d"
                    : controller.myProfile.value.discription!, () async {
